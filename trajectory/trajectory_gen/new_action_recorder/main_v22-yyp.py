...
class ActionRecorder:
    ...
    def _finalize_click_streak(self):
        ...
        if count >= 3:
            self.record_triple_click(x, y, button, step_id, before_ts, after_ts, title_before, title_after)
        elif count == 2:
            self.record_double_click(x, y, button, step_id, before_ts, after_ts, title_before, title_after)
        else:
            self.record_click(x, y, button, step_id, before_ts, after_ts, title_before, title_after)
    ...
    def record_click(self, x, y, button_name, step_id, before_ts_mono_ns, after_ts_mono_ns, app_title_before=None, app_title_after=None):
        action = {
            'type': 'click',
    ...
    def record_double_click(self, x, y, button_name, step_id, before_ts_mono_ns, after_ts_mono_ns, app_title_before=None, app_title_after=None):
        action = {
            'type': 'double_click',
    ...
    def record_triple_click(self, x, y, button_name, step_id, before_ts_mono_ns, after_ts_mono_ns, app_title_before=None, app_title_after=None):
        action = {
            'type': 'triple_click',
    ...
    def record_drag(self, drag_data, step_id, before_ts_mono_ns, after_ts_mono_ns, app_title_before=None, app_title_after=None):
    ...
    def record_scroll(self, x, y, scroll_type, step_id, before_ts_mono_ns, after_ts_mono_ns, app_title_before=None):
        action = {
            'type': 'scroll',
